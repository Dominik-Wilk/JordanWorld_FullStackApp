  ...
  return [
    {
      ...
      price: 184.99,
      description:
        'Elevate your sneaker game with the Air Jordan 1 SE High-Top Sneakers in a timeless beige hue. These iconic high-tops seamlessly blend unique style with outstanding comfort.\n\n' +
    ...
    },
    {
      ...
      price: 159.99,
      description:
        'Step into style and comfort with the WMNS Air Jordan 1 MID 365 High-Top Sneakers. These sneakers redefine casual chic, combining a modern aesthetic with the timeless Air Jordan legacy.\n\n' +
    ...
    },
    {
      ...
      price: 120.0,
      description:
        'The Air Jordan 1 Mid SE is an iconic pair of shoes that seamlessly blends unique style with outstanding comfort.\n\n' +
    ...
    },
    {
      ...
      price: 149.99,
      description:
        'Elevate your sneaker game with the Air Jordan 1 High-Top Sneakers in a vibrant green hue. These iconic high-tops seamlessly blend streetwear style with outstanding comfort, making them a must-have for sneaker enthusiasts.\n\n' +
        '- Achieve a personalized fit with the secure lace-up closure\n' +
    ...
    },
    {
      ...
      price: 154.99,
      description:
        'Step into a realm of timeless style and exceptional comfort with the Air Jordan 1 High-Top Sneakers in an elegant white and brown colorway. These iconic high-tops seamlessly fuse classic design with modern flair, establishing themselves as essential footwear for sneaker enthusiasts.\n\n' +
    ...
    },
    {
      ...
      price: 124.99,
      description:
        'Step into the epitome of timeless style and unparalleled comfort with the Air Jordan 1 High-Top Sneakers in an enchanting white and pink colorway. These iconic high-tops flawlessly blend classic design with a modern touch, solidifying their status as essential footwear for passionate sneaker enthusiasts.\n' +
    ...
    },
    {
      ...
      price: 99.99,
      description:
        'Elevate your sneaker game with the Air Jordan 1 High-Top Sneakers in a captivating shade of purple. These iconic high-tops seamlessly merge bold design with exceptional comfort, establishing themselves as a must-have for dedicated sneaker enthusiasts.\n\n' +
        '- Immerse yourself in the artistry of impeccable craftsmanship, featuring premium suede and leather panels that adorn the upper\n' +
        '- Achieve a personalized fit with the secure lace-up closure\n' +
        '- Soft suede overlays pay homage to vintage materials, while durable textile underlays ensure enduring quality\n' +
        '- Perforations on the heel not only enhance breathability but also add a distinctive touch of style\n' +
    ...
    },
    {
      ...
      price: 180.0,
      description:
        'Step into the epitome of chic style and comfort with the WMNS Air Jordan 1 MID 365 High-Top Sneakers in pristine white. These iconic high-tops redefine casual elegance, seamlessly blending modern aesthetics with the timeless Air Jordan legacy.\n\n' +
        '- Immerse yourself in impeccable craftsmanship with the premium suede and leather panels adorning the upper\n' +
        '- Achieve a personalized fit with the secure lace-up closure\n' +
        '- Experience an added touch of sophistication as the iconic Nike Swoosh elegantly wraps around the heel, forming a convenient pull tab\n' +
        '- Indulge in superior comfort with a padded collar and an exposed foam tongue\n' +
...
function getCartItems() {
  return [
    ...
    },
    {
      ...
      size: '11US',
      comment:
        'Please use gift wrap for packaging. Send without an invoice (the invoice will be sent to my email address).',
    },
  ];
}
